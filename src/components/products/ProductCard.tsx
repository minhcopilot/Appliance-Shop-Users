    ...
    <div className="bg-white rounded-lg shadow-md overflow-hidden max-w-[400px] h-[380px] w-full">
      <Link href={`/products/${data.id}`}>
        <div className="relative">
          ...
          />
          <button className="absolute bottom-2 right-2 bg-yellow-500 text-white font-bold p-3 rounded-full flex items-center justify-center hover:bg-yellow-600 transition-colors duration-300">
            <FaCartPlus />
          </button>
        </div>
